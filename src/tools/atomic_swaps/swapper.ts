...
import { AtomicSwapConfig, validateConfig } from "./config.js";
...
export class AtomicSwapper {
  ...
  constructor(config: AtomicSwapConfig) {
    ...
    this.factory = new SwapperFactory([StarknetInitializer] as any);
